//Han, Charley - CIS17C - Assignment #6 - Circular Linked List operations
...
int main(int argc, char** argv)
{
    ...
    testlist.insertNode(25,3);
    cout << "List after inserting value 25 at position 3: "; testlist.printNodeValue(); cout << endl;
